...
const ponto = document.getElementById("•"); // alt 7 para: •;
const somar = document.getElementById("+");
const subtrair = document.getElementById("—");//alt 0151 para: -;
...
igual.onclick = function (){
    ...
    switch(operacao){
        ...
        case "somar":
        rs = parseFloat(valor1) + parseFloat(display.innerHTML) // pois o sinal de mais concatena innerhtml
        display.innerHTML = rs
        break;
    ...
    //botar botão apagar = tirar o display e por 0
    //botão de raiz quadrada
    //por display dos números que estão sendo digitados
}
